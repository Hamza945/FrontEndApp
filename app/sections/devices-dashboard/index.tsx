    ...
    <section className="bg-[#F9F9F9]  overflow-hidden rounded-[100px]  h-full">
      <div className="pt-[100px]  pl-10 relative z-[2]">
        <div className="flex justify-between items-start">
          <div>
            <Reveal>
              <p className="text-4xl text-moniepoint-black">
...
const AccordionHeader = ({
  ...
  return (
    ...
    >
      <p className="text-lg text-moniepoint-black">{title}</p>
      <button className="text-moniepoint-black text-lg bg-[#f0f0f0] h-[40px] w-[40px]  flex items-center justify-center rounded-full">
        +
      </button>
    </motion.div>
  );
