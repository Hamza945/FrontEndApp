    ...
    <footer className="bg-black pt-[50px]">
      <div className="max-w-[1300px] mx-auto p-10">
        <Reveal delay={0.1} className="flex justify-between items-center text-white ">
          <ul className="flex gap-8 text-moniepoint-grey-100">
            <li>About</li>
            <li>Why Us </li>
            <li>Platform</li>
            <li>Pricing</li>
          ...
          <div className="flex justify-between items-center">
            <div className="flex gap-20">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-moniepoint-grey-100 text-[13px] font-light">
                  1418 Vineyard Drive, NC
                </p>
                <p className="text-moniepoint-grey-100 text-[13px] font-light">44128</p>
              </div>
              <div className="flex flex-col gap-1">
                <p className="text-white">Saint Louis</p>
                <p className="text-moniepoint-grey-100 text-[13px] font-light">1366 Penn Street</p>
                <p className="text-moniepoint-grey-100 text-[13px] font-light">63101</p>
              </div>
            </div>
