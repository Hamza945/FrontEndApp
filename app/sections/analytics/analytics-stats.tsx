  ...
  return (
    <div className="bg-white pt-8 pl-8  border border-[#e6e6e67b] rounded-[50px] shadow-xl shadow-[#eaeaea84] flex justify-between items-center gap-8 overflow-hidden flex-[60%]">
      <div className="flex flex-col self-start">
        <Button className="self-start bg-moniepoint-yellow text-moniepoint-black rounded-lg py-2 px-3 text-[10px]  shadow-lg">
          Setting up reports
        </Button>
      ...
      <div className="border rounded-[25px] border-b-0 rounded-bl-none rounded-r-none p-4 flex flex-col gap-2">
        <p className="text-moniepoint-black text-sm">Sales statistic</p>
        ...
        <div className="flex justify-between items-center gap-4">
          <div className="flex justify-center items-center gap-3">
            <motion.span
              ...
              className="inline-flex rounded-[50px] bg-moniepoint-orange justify-center items-center w-[45px] h-[45px]"
            >
              <Image
                alt="user-connecting"
